...
Les dejo [otro experimiento][5] con todos los atributos que se pueden configurar en un alerta. En clase definimos un [*custom* Popup][] que maneja dos campos en lugar de uno, se los dejo.
