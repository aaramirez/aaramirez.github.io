...
P.D: Si la hay. Básicamente en lugar de deshabilitar el *cache* en toda la aplicación se puede capturar el evento en el padre y el menú es autogestionado por el padre y los hijos no tienen que hacer nada para gestionar el estado del menú.
